...
var vm = new Vue({
  ...
  data: {
    ...
    videodescription: "vid description here",
    videosource: "",
  ...
  created: function() {
    // vue instance is ready to go, mostly - add some live data tot the VM
    console.log('created lifecycle hook fired, go get the data');
    this.fetchUsers();
  },
  ...
  methods: {
    logInOut() {
      ...
      // eventually we'll use routing and login coponent
      ...
      // left of the colon. of it's false, use the value to the right
